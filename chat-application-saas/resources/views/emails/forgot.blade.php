...
<div style="padding-top:13px">
		<p>Please click on this button for change your password.</p> </br>
	...
	<a target="_blank"
	style="padding:15px;width:250px;text-align:center;background:#599100;text-decoration:none;color:#f4f4f4" href="{{URL::to('resetpassword')}}/{{$emaildata['link']}}">Click here</a>
